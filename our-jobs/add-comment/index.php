<?php
  ...
  if(isset($response_recaptcha) && $response_recaptcha){
    ...
    if($validation_server["success"] == true){
      ...
      require_once $_SERVER["DOCUMENT_ROOT"]."/our-jobs/components/notificacion.php";
  ...
  $_SESSION['content_modal'] = "
    <p>Thank you for posting your comment.</p>
    <p>When approved by the WEB administrator it will become visible.</p>
    <p>We take this opportunity to greet you sincerely.</p>";
