...
<div class="container">
  <div class="content">
    ...
    <div class="create-post">
      ...
      <form id="frm-test" action="/our-jobs/core/createPost.php" method="post" enctype="multipart/form-data">
...
<!-- 
        ...
        <div class="gruop">
          <label class="text" for=""><strong>URL del Post</strong></label>
          <input type="text" name="uri_en" id='input-uri' required>
        </div> -->
...
<!-- 
        ...
        <div class="public-post">
          ...
          <label class="text" for="post-raiz"><strong>¿You want to prioritize this Post?</strong></label>
        </div>
        ...
        <button id="btn-enviar" type="submit">Create Post</button>
      </form>
    </div>
  </div>
</div>