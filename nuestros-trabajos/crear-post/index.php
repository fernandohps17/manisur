...
require_once($_SERVER["DOCUMENT_ROOT"]."/nuestros-trabajos/components/data/dataCreatePost.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/nuestros-trabajos/components/header.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/nuestros-trabajos/components/createPost.php");
