<?php 
  ...
  require_once $_SERVER["DOCUMENT_ROOT"]."/nuestros-trabajos/components/cardPostHome.php";
  require_once $_SERVER["DOCUMENT_ROOT"]."/nuestros-trabajos/components/pagination.php";
