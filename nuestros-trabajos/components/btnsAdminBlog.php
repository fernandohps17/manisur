  ...
  if(isset($_SESSION['login'])){
    ...
    echo '<div class="btns-admin-blog">
            <div class="content-btm">
              <p class="btm-admin btm-primary" id="btn-open-option" title="Opciones de Administrador"> 
                <i class="">
              ...
              <a class="btm-admin btm-secundary1" href="/nuestros-trabajos/crear-post/" title="Crear Post">
                <i class="">
              ...
              <a class="btm-admin btm-secundary2" href="/nuestros-trabajos/administrador/" title="Cambiar Contraseña"> 
                <i class="">
              ...
              <a class="btm-admin btm-secundary3" href="/nuestros-trabajos/post-pendientes/" title="Post Pendientes"> 
                <i class="">
