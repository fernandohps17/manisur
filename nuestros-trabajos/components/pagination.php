<?php
  ...
  function pagination($page){ //Recibe la pagina actual
    ...
    $dir = scandir($_SERVER["DOCUMENT_ROOT"].'/nuestros-trabajos/pagina/');
    ...
    echo '<div class="pagination">';
            ...
            if($min != 1){ 
              echo "<a href='/nuestros-trabajos/'>1</a>";
            }
            ...
            for ($i=$min; $i <= $max ; $i++) { 
              if($i == $page){
                if($i == 1){
                  echo "<a href='/nuestros-trabajos/' class='pagination-active'>$i</a>";
                }else{
                  echo "<a href='/nuestros-trabajos/pagina/$i/' class='pagination-active'>$i</a>";
                }
              }else{
                if($i == 1){
                  echo "<a href='/nuestros-trabajos/'>$i</a>";
                }else{
                  echo "<a href='/nuestros-trabajos/pagina/$i/'>$i</a>";
                }
              }
            }
            ...
            if($max != $dir && $max != 0){ 
              echo "<a href='/nuestros-trabajos/pagina/$dir/'>$dir</a>";
            }
    echo "</div>";
  }
?>